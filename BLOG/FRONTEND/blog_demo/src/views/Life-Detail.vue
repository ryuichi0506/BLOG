<template>
    <div class="container" v-wechat-title="$route.meta.title">
        ...
        <div class="main">
            ...
            <div v-else class="life-container">
                <el-row :gutter="30">
                    
                    <!-- 文章 -->
                    <el-col :span="17">
                        <div class="cover">
                            <img draggable="false" :src="blogDetail.lifeCover">
                        </div>
                        <div class="title">{{blogDetail.lifeTitle}}</div>
                        <div class="info">
                            <span class="updatetime" v-if="blogDetail.lifeUpdatetime">最后更新于: {{blogDetail.lifeUpdatetime | formatDate('yyyy-MM-dd hh:mm:ss')}}</span>
                            <span class="views">
                                {{blogDetail.lifeViews}} 人浏览
                            </span>
                            <span class="comments">
                                {{blogDetail.lifeComments}} 条评论
                            </span>
                        </div>
                        <div class="content" v-html="blogDetail.lifeContent"></div>
                        <div class="tags">
                        ...
                        <div class="createinfo">
                            ...
                            <span class="createtime">发布于: {{blogDetail.lifeCreatetime | formatDate('yyyy-MM-dd hh:mm:ss')}}</span>
                        </div>
        ...
        lifeDetail() {
            ...
            this.$http.post(
                ...
                function (res) {
                    ...
                    this_.$route.meta.title = this_.blogDetail.lifeTitle;

                    this_.commentArticleId = this_.blogDetail.lifeId;
                    this_.commentArticleSortId = this_.blogDetail.lifeSortId;
                    this_.commentObjectId = this_.blogDetail.user.userId;

                    this_.query.articleId = this_.blogDetail.lifeId;
                    this_.query.articleSortId = this_.blogDetail.lifeSortId;
                    this_.getComment();
                }
            ).catch(
                function (res) {
