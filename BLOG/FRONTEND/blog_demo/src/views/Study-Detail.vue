        ...
        <div class="main">
            ...
            <div v-else class="study-container">
                <el-row :gutter="30">
                    ...
                    <el-col :span="17">
                        <div class="cover">
                            <img :src="blogDetail.studyCover">
                        </div>
                        <div class="title">{{blogDetail.studyTitle}}</div>
                        <div class="info">
                            <el-tag class="type" size="small" type="success" v-if="blogDetail.studyType === 0">原创</el-tag>
                            <el-tag class="type" size="small" type="danger" v-if="blogDetail.studyType === 1">转载</el-tag>
                            <span class="updatetime" v-if="blogDetail.studyUpdatetime">最后更新于: {{blogDetail.studyUpdatetime | formatDate('yyyy-MM-dd hh:mm:ss')}}</span>
                            <span class="views">
                                {{blogDetail.studyViews}} 人浏览
                            </span>
                            <span class="comments">
                                {{blogDetail.studyComments}} 条评论
                            </span>
                        </div>
                        <div class="content" v-html="blogDetail.studyContent"></div>
                        <div class="tags">
                        ...
                        <div class="createinfo">
                            ...
                            <span class="createtime">发布于: {{blogDetail.studyCreatetime | formatDate('yyyy-MM-dd hh:mm:ss')}}</span>
                        </div>
        ...
        studyDetail() {
            ...
            this.$http.post(
                ...
                function (res) {
                    ...
                    this_.$route.meta.title = this_.blogDetail.studyTitle;

                    this_.commentArticleId = this_.blogDetail.studyId;
                    this_.commentArticleSortId = this_.blogDetail.studySortId;
                    this_.commentObjectId = this_.blogDetail.user.userId;

                    this_.query.articleId = this_.blogDetail.studyId;
                    this_.query.articleSortId = this_.blogDetail.studySortId;
                    this_.getComment();
                }
            ).catch(
                function (res) {
