<template>
    <div class="container">
        <!-- 用户列表 -->
        <el-table :data="myStudyBlogs" stripe>
            ...
            <el-table-column label="操作" width="210px">
                <template slot-scope="scope">
                    ...
                    <!-- 查看按钮 -->
                    <el-button type="primary" size="mini" @click="toStudyDetail(scope.row.studyId)">查看</el-button>
                    <!-- 删除按钮 -->
        ...
        getMyStudyBlogs() {
            ...
            this.$http.post(
                ...
                function (res) {
                    console.log("res =");
                    console.log(res);
                    this_.myStudyBlogs = res.data.list;
